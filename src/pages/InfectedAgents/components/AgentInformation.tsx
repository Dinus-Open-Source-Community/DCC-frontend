    ...
    <div className="w-full lg:w-72 shrink-0 space-y-3 h-fit">
      <div className="rounded-md border border-green/30 bg-[#0A0F0A] p-3.5">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-xs font-semibold tracking-wider uppercase text-green">
            IDENTITY
          </h3>
          <span
            className={[
        ...
        <div className="space-y-3 font-mono">
          <div>
            <div className="mb-1 text-[10px] text-gray-500 uppercase tracking-wider">
              IP ADDRESS
            </div>
          ...
          <div>
            ...
            <div className="text-xs text-gray-200">
              {client.hostname} <span className="text-green">\</span>{" "}
              {client.username}
            </div>
          </div>
          <div>
      ...
      <div className="rounded-md border border-green/30 bg-[#0A0F0A] p-3.5">
        ...
        <div className="relative mb-3 h-28 w-full overflow-hidden border border-green/20 bg-[#131713] flex items-center justify-center">
          <div className="text-xs text-green/20 font-mono tracking-wider">
            MAP SENSOR ONLINE
          </div>
        ...
        <div className="flex flex-col gap-1.5 font-mono text-xs text-gray-300">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-right truncate max-w-[160px]" title={isp}>
              {isp}
            </span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-2.5">
            ...
            <div className="rounded border border-green/20 bg-[#0F140F] p-2.5 font-mono flex flex-col justify-between">
              ...
              <div className="mt-auto">
                <div className="mb-1.5 text-[9px] text-gray-500 opacity-0 hidden">
                  USED
                </div>
                <div className="h-1 w-full rounded-full bg-green/10">
